...
namespace PrinBarCode.DataModel
{
    ...
    {
        /// <summary>
        /// Получаем в качестве аргумента дату из ui, стучимся в базу за данными о зашифрованной дате
        /// на выходе получаем зашифрованную дату по Bosch-Norm N41A_A4 вида MYY DD 0000
        /// Где MYY будет зашифрованый месяц и год полученный из бд, а DD день месяца последние 4 цифры просто нули.
        /// </summary>
